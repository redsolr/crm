...
export const IconNewChat = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    stroke="currentColor"
    fill="none"
    strokeWidth="2"
...
export const IconExamples = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    stroke="currentColor"
    fill="none"
    strokeWidth="1.5"
...
export const IconCapabilities = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    stroke="currentColor"
    fill="none"
    strokeWidth="1.5"
...
export const IconLimitations = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    stroke="currentColor"
    fill="none"
    strokeWidth="1.5"
...
export const ReorderIcon = ({
  ...
  <div
    className="cursor-grab active:cursor-grabbing text-[var(--theme-text-secondary)] hover:text-gray-200 touch-none flex-shrink-0 w-6 h-6 flex items-center justify-center"
...
export const ChevronIcon = ({ isExpanded }: { isExpanded?: boolean }) => (
  <svg
    ...
    viewBox="0 0 24 24"
    fill="none"
    className={`text-[var(--theme-text-secondary)] transform transition-transform ${
...
export const IconChatBubble = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    width="14"
    height="14"
    viewBox="0 0 24 24"
...
export const IconChevronRight = (
  props: React.SVGProps<SVGSVGElement> & { isOpen?: boolean },
) => {
  ...
  return (
    <svg
      ...
      stroke="currentColor"
      strokeWidth="2"
      className={`transform transition-transform ${isOpen ? "rotate-90" : ""} ${className || ""}`}
      {...rest}
    >
