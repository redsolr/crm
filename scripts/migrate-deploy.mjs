/**
 * Deploy-time migration runner (Vercel `vercel-build` step).
 *
 ...
 * The env var is marked sensitive in Vercel (unreadable via CLI pull),
 * which is also why migrations run here instead of from a laptop.
 *
