 ...
 *
 * `GET /v1/workspaces/:workspaceId/work_item_types` — the per-workspace
 ...
 * `/v1/projects/:projectId/work_item_types` was renamed to
 * `/v1/workspaces/:workspaceId/work_item_types`; the row's
